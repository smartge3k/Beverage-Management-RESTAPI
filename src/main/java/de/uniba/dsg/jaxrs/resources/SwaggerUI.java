...
public class SwaggerUI{
	...
	private static final String SWAGGER_UI_FILES = "META-INF/resources/webjars/swagger-ui/"
	      + properties.getProperty("swaggeruiversion");
	...
	public Response showSwaggerUI(@PathParam("file") final String file) {
		...
		return Objects.isNull(resource) ? Response.status(Response.Status.NOT_FOUND).build()
